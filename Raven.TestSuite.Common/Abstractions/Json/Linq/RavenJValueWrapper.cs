...
namespace Raven.TestSuite.Common.Abstractions.Json.Linq
{
	...
	/// </summary>
	public class RavenJValueWrapper : RavenJTokenWrapper, IEquatable<RavenJValueWrapper>, IFormattable, IComparable, IComparable<RavenJValueWrapper>
	{
		...
		/// <summary>
		/// Gets or sets the underlying tokenWrapper value.
		/// </summary>
		/// <value>The underlying tokenWrapper value.</value>
		public object Value
		{
			get { return _value; }
			set
		...
		internal RavenJValueWrapper(object value, JTokenType type)
		{
			_value = value;
			_valueType = type;
		}
		...
		{
			return new RavenJValueWrapper(Value, Type);
		}
		...
		public RavenJValueWrapper(int value)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(long value)
			: this(value, JTokenType.Integer)
		{
		}
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(double value)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(float value)
			: this(value, JTokenType.Float)
		{
		}
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(DateTime value)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(bool value)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(string value)
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(Guid value)
			: this(value, JTokenType.String)
		{
		}
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(Uri value)
			: this(value, JTokenType.String)
		{
		}
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(TimeSpan value)
			: this(value, JTokenType.String)
		{
		}
		...
		/// </summary>
		/// <param name="value">The value.</param>
		public RavenJValueWrapper(object value)
		...
		public new static RavenJValueWrapper Load(JsonReader reader)
		{
			RavenJValueWrapper v;
			switch (reader.TokenType)
			{
				...
				case JsonToken.Bytes:
					v = new RavenJValueWrapper(reader.Value);
					break;
				case JsonToken.Null:
					v = new RavenJValueWrapper(null, JTokenType.Null);
					break;
				case JsonToken.Undefined:
					v = new RavenJValueWrapper(null, JTokenType.Undefined);
					break;
				default:
					throw new InvalidOperationException(StringUtils.FormatWith("The JsonReader should not be on a tokenWrapper of type {0}.", CultureInfo.InvariantCulture,
																		reader.TokenType));
			}
			return v;
		}
		...
		public override void WriteTo(JsonWriter writer, params JsonConverter[] converters)
		{
			...
			throw MiscellaneousUtils.CreateArgumentOutOfRangeException("TokenType", _valueType, "Unexpected tokenWrapper type.");
		}
		...
		public override bool Equals(object obj)
		{
			...
			var otherValue = obj as RavenJValueWrapper;
		...
		int IComparable.CompareTo(object obj)
		{
			...
			var otherValue = (obj is RavenJValueWrapper) ? ((RavenJValueWrapper)obj).Value : obj;

			return Compare(_valueType, _value, otherValue);
		}

		public bool Equals(RavenJValueWrapper other)
		{
		...
		private static bool ValuesEquals(RavenJValueWrapper v1, RavenJValueWrapper v2)
		{
		...
		public int CompareTo(RavenJValueWrapper other)
		{
		...
		internal override bool DeepEquals(RavenJTokenWrapper node)
		{
			if (Type == JTokenType.Null && node == null)
				return true;

			var other = node as RavenJValueWrapper;
			if (other == null)
				return false;
		...
		public static RavenJValueWrapper Null
		{
			get { return new RavenJValueWrapper(null, JTokenType.Null); }
		}

		public static RavenJTokenWrapper Load(JsonTextReaderAsync reader)
		{
			RavenJValueWrapper v;
			switch (reader.TokenType)
			{
